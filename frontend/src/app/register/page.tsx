    ...
    <div className="mx-auto grid min-h-[calc(100vh-70px)] max-w-5xl gap-8 px-4 py-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
      <div className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm">
        ...
        <p className="mt-4 text-sm leading-6 text-gray-600">
          Сейчас доступны фиксированные демо-задания без регистрации. В следующем этапе аккаунт позволит получать стартовый баланс кредитов, открывать больше вариантов, сохранять историю и покупать дополнительные кредиты для AI-проверок.
        </p>
